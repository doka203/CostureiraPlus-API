...
INSERT INTO tb_pedido (descricao, dataPedido, dataEntrega, status, formaPagamento, numeroParcelas, id_usuario_cliente, id_usuario_costureira) VALUES ('Vestido de festa', '2025-06-01', '2025-06-20', 'EM ANDAMENTO', 'CARTAO', 3, 2, 1);
INSERT INTO tb_pedido (descricao, dataPedido, dataEntrega, status, formaPagamento, numeroParcelas, id_usuario_cliente, id_usuario_costureira) VALUES ('Camisa social', '2025-06-02', '2025-06-15', 'FINALIZADO', 'DINHEIRO', 1, 3, 1);
INSERT INTO tb_pedido (descricao, dataPedido, dataEntrega, status, formaPagamento, numeroParcelas, id_usuario_cliente, id_usuario_costureira) VALUES ('Calça jeans', '2025-06-03', '2025-06-18', 'EM ANDAMENTO', 'PIX', 2, 4, 1);
...
INSERT INTO tb_pagamento (dataVencimento, dataPagamento, valor, id_pedido) VALUES ('2025-06-20', '2025-06-20', 300.00, 1);
INSERT INTO tb_pagamento (dataVencimento, dataPagamento, valor, id_pedido) VALUES ('2025-06-15', '2025-06-15', 120.00, 2);
INSERT INTO tb_pagamento (dataVencimento, dataPagamento, valor, id_pedido) VALUES ('2025-06-18', NULL, 150.00, 3);
